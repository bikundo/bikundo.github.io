    ...
    var e = jQuery,
        ...
        n = function() {
            ...
            return t.prototype.init = function() {
                ...
                if (u) {
                    s = e(t.prop("tagName") + '[data-lightbox="' + u + '"]');
                    for (var f = 0; f < s.length; f = ++f) n(e(s[f])), s[f] === t[0] && (o = f)
                } else if ("lightbox" === t.attr("rel")) n(t);
                else {
                    s = e(t.prop("tagName") + '[rel="' + t.attr("rel") + '"]');
                    for (var l = 0; l < s.length; l = ++l) n(e(s[l])), s[l] === t[0] && (o = l)
                }
                ...
                i.onload = function() {
                    var s, o, u, f, l, h, p;
                    r.attr("src", n.album[t].link), s = e(i), r.width(i.width), r.height(i.height), n.options.fitImagesInViewport && (p = e(window).width(), h = e(window).height(), l = p - n.containerLeftPadding - n.containerRightPadding - 20, f = h - n.containerTopPadding - n.containerBottomPadding - 120, (i.width > l || i.height > f) && (i.width / l > i.height / f ? (u = l, o = parseInt(i.height / (i.width / u), 10), r.width(u), r.height(o)) : (o = f, u = parseInt(i.width / (i.height / o), 10), r.width(u), r.height(o)))), n.sizeContainer(r.width(), r.height())
                ...
                function n() {
                    r.$lightbox.find(".lb-dataContainer").width(o), r.$lightbox.find(".lb-prevLink").height(u), r.$lightbox.find(".lb-nextLink").height(u), r.showImage()
                }
                var r = this,
                    ...
                    u = t + this.containerTopPadding + this.containerBottomPadding;
                i !== o || s !== u ? this.$outerContainer.animate({
                    width: o,
                    height: u
                ...
                i === t || s.match(/x|o|c/) ? this.end() : "p" === s || i === n ? 0 !== this.currentImageIndex ? this.changeImage(this.currentImageIndex - 1) : this.options.wrapAround && this.album.length > 1 && this.changeImage(this.album.length - 1) : ("n" === s || i === r) && (this.currentImageIndex !== this.album.length - 1 ? this.changeImage(this.currentImageIndex + 1) : this.options.wrapAround && this.album.length > 1 && this.changeImage(0))
...
(function(e) {
    ...
    var t = e(window),
        n = function(e, t) {
            e.addClass(t.errorElementClass).removeClass("valid").parent().addClass("has-error").removeClass("has-success");
            if (t.borderColorOnError !== "") {
                e.css("border-color", t.borderColorOnError)
            }
        },
        r = function(t, n) {
            t.each(function() {
                i(e(this), "", n, n.errorMessagePosition);
                e(this).removeClass("valid").removeClass(n.errorElementClass).css("border-color", "").parent().removeClass("has-error").removeClass("has-success").find("." + n.errorMessageClass).remove()
            })
        },
        i = function(t, n, r, i) {
            var o = s(t);
            if (o) {
                ...
                var u = false;
                i.find("." + r.errorMessageClass).each(function() {
                    if (this.inputReferer == t[0]) {
                        u = e(this);
                        return false
                    }
                });
                if (u) {
                    ...
                    var a = e('<div class="' + r.errorMessageClass + '">' + n + "</div>");
                    a[0].inputReferer = t[0];
                    i.prepend(a)
                }
            } else {
                var a = t.parent().find("." + r.errorMessageClass + ".help-block");
                if (a.length == 0) {
                    a = e("<span></span>").addClass("help-block").addClass(r.errorMessageClass);
                    a.appendTo(t.parent())
                }
                a.html(n)
            }
        ...
        o = function(t, n, r, i) {
            var s = i.errorMessageTemplate.messages.replace(/\{errorTitle\}/g, n);
            var o = [];
            e.each(r, function(e, t) {
                o.push(i.errorMessageTemplate.field.replace(/\{msg\}/g, t))
            });
            s = s.replace(/\{fields\}/g, o.join(""));
            var u = i.errorMessageTemplate.container.replace(/\{errorMessageClass\}/g, i.errorMessageClass);
            u = u.replace(/\{messages\}/g, s);
            t.children().eq(0).before(u)
        };
    e.fn.validateOnBlur = function(t, n) {
        this.find("input[data-validation],textarea[data-validation],select[data-validation]").bind("blur.validation", function() {
            e(this).validateInputOnBlur(t, n)
        });
        return this
    };
    e.fn.validateOnEvent = function(t, n) {
        this.find("input[data-validation][data-validation-event],textarea[data-validation][data-validation-event],select[data-validation][data-validation-event]").each(function() {
            var r = e(this),
                i = r.attr("data-validation-event");
            if (i) {
                r.bind(i + ".validation", function() {
                    e(this).validateInputOnBlur(t, n, false, i)
                })
            }
        });
        return this
    ...
    e.fn.showHelpOnFocus = function(t) {
        ...
        this.find("textarea,input").each(function() {
            var n = e(this),
                r = "jquery_form_help_" + (n.attr("name") || "").replace(/(:|\.|\[|\])/g, ""),
                i = n.attr(t);
            if (i) {
                n.addClass("has-help-txt").unbind("focus.help").bind("focus.help", function() {
                    var t = n.parent().find("." + r);
                    if (t.length == 0) {
                        t = e("<span />").addClass(r).addClass("help").addClass("help-block").text(i).hide();
                        n.after(t)
                    }
                    t.fadeIn()
    ...
    e.fn.validateInputOnBlur = function(t, s, o, u) {
        if (o === undefined) o = true;
        if (!u) u = "blur";
        if ((this.valAttr("suggestion-nr") || this.valAttr("postpone") || this.hasClass("hasDatepicker")) && !window.postponedValidation) {
            var a = this,
                f = this.valAttr("postpone") || 200;
            window.postponedValidation = function() {
                a.validateInputOnBlur(t, s, o);
        ...
        var l = this,
            c = l.closest("form"),
            h = l.attr(s.validationRuleAttribute),
            p = e.formUtils.validateInput(l, t, e.extend({}, s, {
                errorMessagePosition: "element"
            }), c, u);
        l.trigger("validation", [p === null ? null : p === true]);
        if (p === true) {
            l.addClass("valid").parent().addClass("has-success")
        } else if (p !== null) {
            n(l, s);
            i(l, p, s, s.errorMessagePosition);
            if (o) {
                l.bind("keyup", function() {
                    e(this).validateInputOnBlur(t, s, false, "keyup")
                })
            }
        }
        return this
    ...
    e.fn.valAttr = function(e, t) {
        if (t === undefined) {
            return this.attr("data-validation-" + e)
        } else if (t === false || t === null) {
            return this.removeAttr("data-validation-" + e)
        } else {
            if (e.length > 0) e = "-" + e;
            return this.attr("data-validation" + e, t)
        }
    };
    e.fn.isValid = function(s, u, a) {
        ...
        u = e.extend({}, e.formUtils.defaultConfig(), u || {});
        s = e.extend({}, e.formUtils.LANG, s || {});
        a = a !== false;
        e.formUtils.isValidatingEntireForm = true;
        e.formUtils.haltValidation = false;
        var l = function(t, r) {
                if (t !== null) {
                    if (e.inArray(t, c) < 0) {
                        c.push(t)
            ...
            p = this,
            d = function(t, n) {
                if (n === "submit" || n === "button" || n == "reset") {
                    return true
                }
                return e.inArray(t, u.ignore || []) > -1
            };
        if (a) {
            p.find("." + u.errorMessageClass + ".alert").remove();
            r(p.find("." + u.errorElementClass + ",.valid"), u)
        }
        p.find("input,textarea,select").filter(':not([type="submit"],[type="button"])').each(function() {
            var t = e(this);
            var n = t.attr("type");
            if (!d(t.attr("name"), n)) {
                var r = e.formUtils.validateInput(t, s, u, p, "submit");
                t.trigger("validation", [r === true]);
                if (typeof u.onElementValidate == "function") {
                    u.onElementValidate(r === true, t, p, r)
                }
                if (r !== true) {
                    l(r, t)
                } else {
                    t.valAttr("current-error", false).addClass("valid").parent().addClass("has-success")
                }
            }
        });
        if (typeof u.onValidate == "function") {
            var v = u.onValidate(p);
            if (e.isArray(v)) {
                e.each(v, function(e, t) {
                    l(t.message, t.element)
                })
            } else if (v && v.element && v.message) {
                l(v.message, v.element)
            }
        }
        e.formUtils.isValidatingEntireForm = false;
        if (!e.formUtils.haltValidation && h.length > 0) {
            if (a) {
                if (u.errorMessagePosition === "top") {
                    o(p, s.errorTitle, c, u)
                } else if (u.errorMessagePosition === "custom") {
                    if (typeof u.errorMessageCustom === "function") {
                        u.errorMessageCustom(p, s.errorTitle, c, u)
                    }
                } else {
                    e.each(h, function(e, t) {
                        i(t, t.attr("current-error"), u, u.errorMessagePosition)
                    })
                } if (u.scrollToTopOnError) {
                    t.scrollTop(p.offset().top - 20)
                }
            }
            return false
        }
        return !e.formUtils.haltValidation
    };
    e.fn.validateForm = function(e, t) {
        if (window.console && typeof window.console.warn == "function") {
            window.console.warn("Use of deprecated function $.validateForm, use $.isValid instead")
        }
        return this.isValid(e, t, true)
    };
    e.fn.restrictLength = function(t) {
        new e.formUtils.lengthRestriction(this, t);
        return this
    };
    e.fn.addSuggestions = function(t) {
        ...
        this.find("input").each(function() {
            var r = e(this);
            n = e.split(r.attr("data-suggestions"));
            if (n.length > 0 && !r.hasClass("has-suggestions")) {
                e.formUtils.suggest(r, n, t);
    ...
    e.split = function(t, n, r) {
        if (typeof n != "function") {
            if (!t) return [];
            var i = [];
            e.each(t.split(n ? n : ","), function(t, n) {
                n = e.trim(n);
            ...
            e.each(t.split(r), function(t, r) {
                r = e.trim(r);
                if (r.length) return n(r, t)
            })
        }
    };
    e.validate = function(n) {
        var i = e.extend(e.formUtils.defaultConfig(), {
            form: "form",
        ...
        e.split(n.form, function(i) {
            ...
            s.bind("submit.validation", function() {
                ...
                var r = t.isValid(n.language, n);
                if (r && typeof n.onSuccess == "function") {
                    var i = n.onSuccess(t);
                    if (i === false) return false
                } else if (!r && typeof n.onError == "function") {
                    n.onError(t);
                    return false
                } else {
                    return r
                ...
                e(this).find("." + n.errorMessageClass + ".alert").remove();
                r(e(this).find("." + n.errorElementClass + ",.valid"), n)
            }).addClass("has-validation-callback");
            if (n.showHelpOnFocus) {
                s.showHelpOnFocus()
            }
            if (n.addSuggestions) {
                s.addSuggestions()
            ...
            if (n.validateOnBlur) {
                s.validateOnBlur(n.language, n);
                s.bind("html5ValidationAttrsFound", function() {
                    s.validateOnBlur(n.language, n)
                })
            }
            if (n.validateOnEvent) {
                s.validateOnEvent(n.language, n)
            }
        });
        if (n.modules != "") {
            if (typeof n.onModulesLoaded == "function") {
                t.one("validatorsLoaded", n.onModulesLoaded)
            }
    ...
    e.formUtils = {
        ...
        addValidator: function(e) {
            var t = e.name.indexOf("validate_") === 0 ? e.name : "validate_" + e.name;
            if (e.validateOnKeyUp === undefined) e.validateOnKeyUp = true;
            this.validators[t] = e
        },
        isLoadingModules: false,
        loadedModules: {},
        loadModules: function(n, r, i) {
            if (i === undefined) i = true;
            if (e.formUtils.isLoadingModules) {
                setTimeout(function() {
                    e.formUtils.loadModules(n, r, i)
                });
                return
            }
            var s = false,
                o = function(n, r) {
                    var o = e.split(n),
                        ...
                        a = function() {
                            u--;
                            if (u == 0) {
                                e.formUtils.isLoadingModules = false;
                                if (i && s) {
                                    t.trigger("validatorsLoaded")
                                }
                            }
                        };
                    if (u > 0) {
                        e.formUtils.isLoadingModules = true
                    }
                    var f = "?__=" + (new Date).getTime(),
                    ...
                    e.each(o, function(t, n) {
                        ...
                        if (n.length == 0) {
                            ...
                            var i = r + n + (n.substr(-3) == ".js" ? "" : ".js"),
                                o = document.createElement("SCRIPT");
                            if (i in e.formUtils.loadedModules) {
                                a()
                            } else {
                                e.formUtils.loadedModules[i] = 1;
                                s = true;
                                o.type = "text/javascript";
                                o.onload = a;
                                o.src = i + (i.substr(-7) == ".dev.js" ? f : "");
        ...
        validateInput: function(t, n, r, i, s) {
            if (t.attr("disabled")) return null;
            t.trigger("beforeValidation");
            var o = e.trim(t.val() || ""),
                u = t.valAttr("optional"),
                a = false,
                f = false,
                l = false,
                c = t.valAttr("if-checked");
            if (c != null) {
                a = true;
                l = i.find('input[name="' + c + '"]');
                if (l.prop("checked")) {
                    f = true
                }
            }
            if (!o && u === "true" || a && !f) {
                return r.addValidClassOnAll ? true : null
            }
            var h = t.attr(r.validationRuleAttribute),
                p = true;
            if (!h) {
                return r.addValidClassOnAll ? true : null
            }
            e.split(h, function(u) {
                if (u.indexOf("validate_") !== 0) {
                    u = "validate_" + u
                }
                var a = e.formUtils.validators[u];
                if (a && typeof a["validatorFunction"] == "function") {
                    if (u == "validate_checkbox_group") {
                        t = e("[name='" + t.attr("name") + "']:eq(0)")
                    }
                    var f = true;
                    if (s != "keyup" || a.validateOnKeyUp) {
                        f = a.validatorFunction(o, t, r, n, i)
                    }
                    if (!f) {
                        p = t.attr(r.validationErrorMsgAttribute + "-" + u.replace("validate_", ""));
                        if (!p) {
                            p = t.attr(r.validationErrorMsgAttribute);
                            if (!p) {
                                p = n[a.errorMessageKey];
                                if (!p) p = a.errorMessage
                            }
                        }
                        return false
                    }
                } else {
                    console.warn('Using undefined validator "' + u + '"')
                }
            }, " ");
            if (typeof p == "string") {
                return p
        ...
        parseDate: function(t, n) {
            var r = n.replace(/[a-zA-Z]/gi, "").substring(0, 1),
                i = "^",
                s = n.split(r),
                o, u, a, f;
            ...
            i += "$";
            o = t.match(new RegExp(i));
            if (o === null) {
                return false
            }
            var l = function(t, n, r) {
                for (var i = 0; i < n.length; i++) {
                    if (n[i].substring(0, 1) === t) {
                        return e.formUtils.parseDateInt(r[i + 1])
                    }
                }
                return -1
            };
            ...
            u = l("d", s, o);
            f = l("y", s, o);
            if (a === 2 && u > 28 && (f % 4 !== 0 || f % 100 === 0 && f % 400 !== 0) || a === 2 && u > 29 && (f % 4 === 0 || f % 100 !== 0 && f % 400 === 0) || a > 12 || a === 0) {
                return false
            }
            if (this.isShortMonth(a) && u > 30 || !this.isShortMonth(a) && u > 31 || u === 0) {
                return false
            }
            return [f, a, u]
        },
        ...
        numericRangeCheck: function(t, n) {
            var r = e.split(n, "-");
            var i = parseInt(n.substr(3), 10);
            if (r.length == 2 && (t < parseInt(r[0], 10) || t > parseInt(r[1], 10))) {
                return ["out", r[0], r[1]]
            } else if (n.indexOf("min") === 0 && t < i) {
                return ["min", i]
            } else if (n.indexOf("max") === 0 && t > i) {
                return ["max", i]
            } else {
                return ["ok"]
            }
        ...
        suggest: function(n, r, i) {
            ...
            var u = function(t) {
                ...
                e(".jquery-form-suggestion-" + n).fadeOut("fast")
            };
            n.data("suggestions", r).valAttr("suggestion-nr", this._numSuggestionElements).unbind("focus.suggest").bind("focus.suggest", function() {
                e(this).trigger("keyup");
                e.formUtils._selectedSuggestion = null
            }).unbind("keyup.suggest").bind("keyup.suggest", function() {
                var t = e(this),
                    r = [],
                    i = e.trim(t.val()).toLocaleLowerCase();
                ...
                var a = false,
                    f = t.valAttr("suggestion-nr"),
                    l = e(".jquery-form-suggestion-" + f);
                l.scrollTop(0);
                if (i != "") {
                    var c = i.length > 2;
                    e.each(t.data("suggestions"), function(e, t) {
                        ...
                        if (n == i) {
                            r.push("<strong>" + t + "</strong>");
                            a = true;
                            return false
                        } else if (n.indexOf(i) === 0 || c && n.indexOf(i) > -1) {
                            r.push(t.replace(new RegExp(i, "gi"), "<strong>$&</strong>"))
                        }
                    })
                }
                if (a || r.length == 0 && l.length > 0) {
                    l.hide()
                } else if (r.length > 0 && l.length == 0) {
                    l = e("<div></div>").css(s.css).appendTo("body");
                    n.addClass("suggestions-" + f);
                    l.attr("data-suggest-container", f).addClass("jquery-form-suggestions").addClass("jquery-form-suggestion-" + f)
                } else if (r.length > 0 && !l.is(":visible")) {
                    l.show()
                }
                if (r.length > 0 && i.length != r[0].length) {
                    o(l, t);
                    l.html("");
                ...
                var n = t.keyCode ? t.keyCode : t.which,
                    r, i, o = e(this);
                if (n == 13 && e.formUtils._selectedSuggestion !== null) {
                    r = o.valAttr("suggestion-nr");
                    i = e(".jquery-form-suggestion-" + r);
                    if (i.length > 0) {
                        var a = i.find("div").eq(e.formUtils._selectedSuggestion).text();
                        o.val(a);
                        u(o);
                        t.preventDefault()
                    }
                    ...
                    i = e(".jquery-form-suggestion-" + r);
                    var f = i.children();
                    if (f.length > 0 && e.inArray(n, [38, 40]) > -1) {
                        if (n == 38) {
                            if (e.formUtils._selectedSuggestion === null) e.formUtils._selectedSuggestion = f.length - 1;
                            else e.formUtils._selectedSuggestion--; if (e.formUtils._selectedSuggestion < 0) e.formUtils._selectedSuggestion = f.length - 1
                        } else if (n == 40) {
                            if (e.formUtils._selectedSuggestion === null) e.formUtils._selectedSuggestion = 0;
                            else e.formUtils._selectedSuggestion++; if (e.formUtils._selectedSuggestion > f.length - 1) e.formUtils._selectedSuggestion = 0
                        }
                        var l = i.innerHeight(),
                            c = i.scrollTop(),
                            h = i.children().eq(0).outerHeight(),
                            p = h * e.formUtils._selectedSuggestion;
                        if (p < c || p > c + l) {
                            i.scrollTop(p)
                        }
                        f.removeClass("active-suggestion").css("background", "none").eq(e.formUtils._selectedSuggestion).addClass("active-suggestion").css(s.activeSuggestionCSS);
                        t.preventDefault();
                        return false
                    }
                }
    ...
    e.formUtils.addValidator({
        ...
        validatorFunction: function(t) {
            ...
            if (n.length == 2) {
                return e.formUtils.validators.validate_domain.validatorFunction(n[1]) && !/[^\w\+\.\-]/.test(n[0])
            }
            return false
        },
        errorMessage: "",
    ...
    e.formUtils.addValidator({
        ...
        validatorFunction: function(e, t) {
            var n = [".ac", ".ad", ".ae", ".aero", ".af", ".ag", ".ai", ".al", ".am", ".an", ".ao", ".aq", ".ar", ".arpa", ".as", ".asia", ".at", ".au", ".aw", ".ax", ".az", ".ba", ".bb", ".bd", ".be", ".bf", ".bg", ".bh", ".bi", ".bike", ".biz", ".bj", ".bm", ".bn", ".bo", ".br", ".bs", ".bt", ".bv", ".bw", ".by", ".bz", ".ca", ".camera", ".cat", ".cc", ".cd", ".cf", ".cg", ".ch", ".ci", ".ck", ".cl", ".clothing", ".cm", ".cn", ".co", ".com", ".construction", ".contractors", ".coop", ".cr", ".cu", ".cv", ".cw", ".cx", ".cy", ".cz", ".de", ".diamonds", ".directory", ".dj", ".dk", ".dm", ".do", ".dz", ".ec", ".edu", ".ee", ".eg", ".enterprises", ".equipment", ".er", ".es", ".estate", ".et", ".eu", ".fi", ".fj", ".fk", ".fm", ".fo", ".fr", ".ga", ".gallery", ".gb", ".gd", ".ge", ".gf", ".gg", ".gh", ".gi", ".gl", ".gm", ".gn", ".gov", ".gp", ".gq", ".gr", ".graphics", ".gs", ".gt", ".gu", ".guru", ".gw", ".gy", ".hk", ".hm", ".hn", ".holdings", ".hr", ".ht", ".hu", ".id", ".ie", ".il", ".im", ".in", ".info", ".int", ".io", ".iq", ".ir", ".is", ".it", ".je", ".jm", ".jo", ".jobs", ".jp", ".ke", ".kg", ".kh", ".ki", ".kitchen", ".km", ".kn", ".kp", ".kr", ".kw", ".ky", ".kz", ".la", ".land", ".lb", ".lc", ".li", ".lighting", ".lk", ".lr", ".ls", ".lt", ".lu", ".lv", ".ly", ".ma", ".mc", ".md", ".me", ".menu", ".mg", ".mh", ".mil", ".mk", ".ml", ".mm", ".mn", ".mo", ".mobi", ".mp", ".mq", ".mr", ".ms", ".mt", ".mu", ".museum", ".mv", ".mw", ".mx", ".my", ".mz", ".na", ".name", ".nc", ".ne", ".net", ".nf", ".ng", ".ni", ".nl", ".no", ".np", ".nr", ".nu", ".nz", ".om", ".org", ".pa", ".pe", ".pf", ".pg", ".ph", ".photography", ".pk", ".pl", ".plumbing", ".pm", ".pn", ".post", ".pr", ".pro", ".ps", ".pt", ".pw", ".py", ".qa", ".re", ".ro", ".rs", ".ru", ".rw", ".sa", ".sb", ".sc", ".sd", ".se", ".sexy", ".sg", ".sh", ".si", ".singles", ".sj", ".sk", ".sl", ".sm", ".sn", ".so", ".sr", ".st", ".su", ".sv", ".sx", ".sy", ".sz", ".tattoo", ".tc", ".td", ".technology", ".tel", ".tf", ".tg", ".th", ".tips", ".tj", ".tk", ".tl", ".tm", ".tn", ".to", ".today", ".tp", ".tr", ".travel", ".tt", ".tv", ".tw", ".tz", ".ua", ".ug", ".uk", ".uno", ".us", ".uy", ".uz", ".va", ".vc", ".ve", ".ventures", ".vg", ".vi", ".vn", ".voyage", ".vu", ".wf", ".ws", ".xn--3e0b707e", ".xn--45brj9c", ".xn--80ao21a", ".xn--80asehdb", ".xn--80aswg", ".xn--90a3ac", ".xn--clchc0ea0b2g2a9gcd", ".xn--fiqs8s", ".xn--fiqz9s", ".xn--fpcrj9c3d", ".xn--fzc2c9e2c", ".xn--gecrj9c", ".xn--h2brj9c", ".xn--j1amh", ".xn--j6w193g", ".xn--kprw13d", ".xn--kpry57d", ".xn--l1acc", ".xn--lgbbat1ad8j", ".xn--mgb9awbf", ".xn--mgba3a4f16a", ".xn--mgbaam7a8h", ".xn--mgbayh7gpa", ".xn--mgbbh1a71e", ".xn--mgbc0a9azcg", ".xn--mgberp4a5d4ar", ".xn--mgbx4cd0ab", ".xn--ngbc5azd", ".xn--o3cw4h", ".xn--ogbpf8fl", ".xn--p1ai", ".xn--pgbs0dh", ".xn--q9jyb4c", ".xn--s9brj9c", ".xn--unup4y", ".xn--wgbh1c", ".xn--wgbl6a", ".xn--xkc2al3hye2a", ".xn--xkc2dl3a5ee0h", ".xn--yfro4i67o", ".xn--ygbi2ammx", ".xxx", ".ye", ".yt", ".za", ".zm", ".zw"],
                r = ["co", "me", "ac", "gov", "judiciary", "ltd", "mod", "net", "nhs", "nic", "org", "parliament", "plc", "police", "sch", "bl", "british-library", "jet", "nls"],
                i = e.lastIndexOf("."),
                s = e.substring(0, i),
            ...
            if (!u) {
                ...
                if (s.split(".").length > 3 || s.split("..").length > 1) {
                    return false
                }
                if (s.replace(/[-\da-z\.]/g, "") !== "") {
                    return false
    ...
    e.formUtils.addValidator({
        name: "required",
        validatorFunction: function(t, n, r, i, s) {
            switch (n.attr("type")) {
                case "checkbox":
                    return n.is(":checked");
                case "radio":
    ...
    e.formUtils.addValidator({
        name: "length",
        validatorFunction: function(t, n, r, i) {
            var s = n.valAttr("length"),
                o = n.attr("type");
            if (s == undefined) {
                var u = n.get(0).nodeName;
                alert('Please add attribute "data-validation-length" to ' + u + " named " + n.attr("name"));
                return true
            }
            var a = o == "file" && n.get(0).files !== undefined ? n.get(0).files.length : t.length,
                f = e.formUtils.numericRangeCheck(a, s),
                l;
            switch (f[0]) {
                case "out":
                    this.errorMessage = i.lengthBadStart + s + i.lengthBadEnd;
                    l = false;
                    break;
                case "min":
                    this.errorMessage = i.lengthTooShortStart + f[1] + i.lengthBadEnd;
                    l = false;
                    break;
                case "max":
                    this.errorMessage = i.lengthTooLongStart + f[1] + i.lengthBadEnd;
                    l = false;
                    break;
                default:
                    l = true
    ...
    e.formUtils.addValidator({
        ...
        validatorFunction: function(t) {
            ...
            if (n.test(t)) {
                ...
                return e.formUtils.validators.validate_domain.validatorFunction(r)
            }
            return false
        },
        errorMessage: "",
    ...
    e.formUtils.addValidator({
        ...
        validatorFunction: function(e, t, n) {
            if (e !== "") {
                var r = t.valAttr("allowing") || "",
                    i = t.valAttr("decimal-separator") || n.decimalSeparator,
                    s = false,
                    o, u;
                if (r.indexOf("number") == -1) r += ",number";
                if (r.indexOf("negative") > -1 && e.indexOf("-") === 0) {
                    e = e.substr(1)
                }
                if (r.indexOf("range") > -1) {
                    o = parseFloat(r.substring(r.indexOf("[") + 1, r.indexOf(";")));
                    u = parseFloat(r.substring(r.indexOf(";") + 1, r.indexOf("]")));
                    s = true
                }
                if (i == ",") {
                    if (e.indexOf(".") > -1) {
                ...
                if (r.indexOf("number") > -1 && e.replace(/[0-9]/g, "") === "" && (!s || e >= o && e <= u)) {
                    return true
                }
                if (r.indexOf("float") > -1 && e.match(new RegExp("^([0-9]+)\\.([0-9]+)$")) !== null && (!s || e >= o && e <= u)) {
                    return true
                }
            }
            return false
    ...
    e.formUtils.addValidator({
        ...
        validatorFunction: function(e, t, n, r) {
            var i = "^([a-zA-Z0-9",
                s = "]+)$",
                o = t.attr("data-validation-allowing"),
                u = "";
            if (o) {
                u = i + o + s;
                var a = o.replace(/\\/g, "");
                ...
                this.errorMessage = r.badAlphaNumeric + r.badAlphaNumericExtra + a
            } else {
                u = i + s;
    ...
    e.formUtils.addValidator({
        name: "custom",
        validatorFunction: function(e, t, n) {
            var r = new RegExp(t.valAttr("regexp"));
            return r.test(e)
        },
        errorMessage: "",
    ...
    e.formUtils.addValidator({
        name: "date",
        validatorFunction: function(t, n, r) {
            var i = "yyyy-mm-dd";
            if (n.valAttr("format")) {
                i = n.valAttr("format")
            ...
            return e.formUtils.parseDate(t, i) !== false
        },
        errorMessage: "",
    ...
    e.formUtils.addValidator({
        ...
        validatorFunction: function(t, n, r, i, s) {
            var o = true;
            var u = n.attr("name");
            var a = e("input[type=checkbox][name^='" + u + "']:checked", s).length;
            var f = n.valAttr("qty");
            if (f == undefined) {
                var l = n.get(0).nodeName;
                alert('Attribute "data-validation-qty" is missing from ' + l + " named " + n.attr("name"))
            }
            var c = e.formUtils.numericRangeCheck(a, f);
            switch (c[0]) {
                case "out":
                    this.errorMessage = i.groupCheckedRangeStart + f + i.groupCheckedEnd;
                    o = false;
                    break;
                case "min":
                    this.errorMessage = i.groupCheckedTooFewStart + c[1] + i.groupCheckedEnd;
                    o = false;
                    break;
                case "max":
                    this.errorMessage = i.groupCheckedTooManyStart + c[1] + i.groupCheckedEnd;
                    o = false;
                    break;
                default:
                    o = true
...
(function(e, t) {
    ...
    n = function(n, r) {
        ...
        var a = function() {
                return u = s._findMultiplier(), s.$el.on("click", s.options.elements.nav + " a", function(e) {
                    ...
                    e = t && !isNaN(t) ? s._upcomingSlide(t - 1) : s._upcomingSlide(t), e >= 0 && e !== s.current && s.animate(e)
            ...
            f = {
                ...
                images: function() {
                    ...
                    e.removeAttr("width").removeAttr("height").css({
                        ...
                        var e = s.image._aspectRatio(this),
                            n = this;
                        if (t.data(this, "processed")) s.image._scale(n, e), s.image._center(n, e);
                        else {
                            var r = new Image;
                            r.onload = function() {
                                s.image._scale(n, e), s.image._center(n, e), t.data(n, "processed", !0)
                            }, r.src = this.src
                        }
                    })
                },
            ...
            l = {
                ...
                fade: function(e, t) {
                    ...
                    s.css({
                        ...
                        opacity: 1,
                        display: "block"
                    }), e.outgoing_slide >= 0 ? i.animate({
                        opacity: 0
                    }, n.options.animation_speed, n.options.animation_easing, function() {
                        n.size() > 1 && (r.eq(e.upcoming_slide).css({
                            zIndex: 2
                        }), e.outgoing_slide >= 0 && r.eq(e.outgoing_slide).css({
                            opacity: 1,
                            display: "none",
                            zIndex: 0
                        })), t()
        ...
        return this.css = f, this.image = c, this.pagination = h, this.fx = l, this.animation = this.fx[this.options.animation], this.$control = this.$container.wrap(o).parent(".slides-control"), s._findPositions(), s.width = s._findWidth(), s.height = s._findHeight(), this.css.children(), this.css.containers(), this.css.images(), this.pagination._setup(), a()
    }, n.prototype = {
        _findWidth: function() {
        ...
        start: function() {
            var n = this;
            n.options.hashchange ? t(e).trigger("hashchange") : this.animate(), this.options.play && (this.play_id && this.stop(), this.play_id = setInterval(function() {
                n.animate()
        ...
        animate: function(t, n) {
            ...
            if (!(this.animating || (this.animating = !0, void 0 === t && (t = "next"), s.upcoming_slide = this._upcomingSlide(t), s.upcoming_slide >= this.size()))) {
                if (s.outgoing_slide = this.current, s.upcoming_position = 2 * this.width, s.offset = -s.upcoming_position, ("prev" === t || s.outgoing_slide > t) && (s.upcoming_position = 0, s.offset = 0), r.size() > 1 && r.pagination._setCurrent(s.upcoming_slide), r.options.hashchange) {
                    var o = s.upcoming_slide + 1,
                        u = r.$container.children(":eq(" + s.upcoming_slide + ")").attr("id");
                    e.location.hash = u ? u : o
                }
                r.$el.trigger("animating.slides", [s]), r.animation(s, function() {
                    r._findPositions(s.upcoming_slide, r), "function" == typeof n && n(), r.animating = !1, r.$el.trigger("animated.slides"), r.init || (r.$el.trigger("init.slides"), r.init = !0, r.$container.fadeIn("fast"))
                })
            }
        }
    }, t.fn[r] = function(e, i) {
        ...
        return this.each(function() {
            var u, a, f;
            return u = t(this), a = u.data(r), f = "object" == typeof e && e, a || (s = u.data(r, a = new n(this, f))), "string" == typeof e && (s = a[e], "function" == typeof s) ? s = s.call(a, i) : void 0
        }), s
    }, t.fn[r].fx = {}
})(this, jQuery);
(function(e) {
    ...
    setInterval(function() {
        ...
        if (l = u.length) {
            ...
            if (!(v = n)) {
                ...
                if (!m.height && ((v = i.compatMode) || !e.support.boxModel)) v = "CSS1Compat" === v ? o : i.body, m = {
            ...
            for (r = r || {
                ...
                if (e.contains(o, u[c])) {
                    ...
                    var g = v.height(),
                        ...
                        m = v.data("inview");
                    if (!r || !n) break;
                    b.top + g > r.top && b.top < r.top + n.height && b.left + y > r.left && b.left < r.left + n.width ? (y = r.left > b.left ? "right" : r.left + n.width < b.left + y ? "left" : "both", g = r.top > b.top ? "bottom" : r.top + n.height < b.top + g ? "top" : "both", b = y + "-" + g, (!m || m !== b) && v.data("inview", b).trigger("inview", [!0, y, g])) : m && v.data("inview", !1).trigger("inview", [!1])
                }
        }
    }, 250)
})(jQuery);
...
$(document).ready(function() {
    ...
    var n = $(".services .row").offset().top;
    var r = $(".timeline").offset().top;
    ...
    $.validate({
        ...
        onSuccess: function() {
            ...
            var e = $("form[name=contactform] input[name='name']").val(),
		fg = $("form[name=contactform] input[name='phone']").val(),
                t = $("form[name=contactform] input[name='email']").val(),
                n = $("form[name=contactform] textarea[name='comments']").val();
            $.ajax({
                url: "http://www.evolva.co.ke/contact.php",
                type: "POST",
                data: {
                    type: "contact",
                    name: e,
